...
lr=5e-5 # Learning Rate of BERT + Linear
lrCRF=7e-3 # Learning Rate of CRF
batchSize=32
numEpochs=100
bertModel="allenai/scibert_scivocab_uncased"
targetDataset="MULMS" # Dataset to perform NER on

######

### Path Settings ###

outputDir="$PROJECT_ROOT/output/ner/bilou_tagging"
