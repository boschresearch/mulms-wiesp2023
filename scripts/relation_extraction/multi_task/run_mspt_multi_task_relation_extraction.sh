...
additionalDatasets="mulms" # Must be one of ["sofc", "mulms"]

### Path Settings ###

outputDir="$PROJECT_ROOT/output/relation_extraction/multi_task/mspt/${additionalDatasets}/${modelNameOrPath}"
...
--config source/relation_extraction/configs/multi_task/mspt/plus_${additionalDatasets}/${modelNameOrPath}.json \
--tune_fold $f                                                                                                  \
--save_dir $outputDir
