# Code taken from https://github.com/kmkurn/pytorch-crf/blob/master/torchcrf/__init__.py
# (MIT license)

"""
This module contains a Pytorch conditional random field (CRF) layer implementation.
"""
